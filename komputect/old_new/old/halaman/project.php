...
?>
    ...
    if(isset($_GET['proyek_dtl'])){
        $Gs_query = mysql_query("select * from project  where produk='$_GET[proyek_dtl]' order by upd_data desc".$limit);
    }else{
      $Gs_query = mysql_query("select * from project $proyek_type order by upd_data desc".$limit);
        ...
        while($Gs_result = mysql_fetch_array($Gs_query)){
            ...
            <div class="content">
                ...
                <div id="name-list_x" class="build" '.$warna.'>'.$build.'</div>
