...
function keywords(){
	...
	if ($sql){
		while ($data = mysql_fetch_row($sql)){
	        ...
	        echo "CV Komputectlift";
	}
}
?>
<title>CV Komputectlift</title>
		...
		?>
   	  <div <?php echo $id;?> class="menu">
        	<ul >
            	...
            	<li><a href="index.php?halaman=proyek">Proyek & Service</a></li>
            	<li><a href="index.php?halaman=about">Tentang Kami</a></li>
            	<li><a href="index.php?halaman=contact">Kontak Kami</a></li>
            </ul>
        </div>
	</div>
    <div id="bot-content">
						...
						<ul class="categoryitems">
                        	<?php 
								...
								while($prod_result = mysql_fetch_array($prod_query)){
									echo '<li><a href="?halaman=produk&product_id='.$prod_result[0].'">'.$prod_result[1].'</a></li>';
								}
							?>
						</ul>				
					<div class="menucenter expandable">Service & Project</div>
						<ul class="categoryitems">
							<?php 
								...
								while($prod_result = mysql_fetch_array($prod_query)){
									echo '<li><a href="?halaman=proyek&proyek_dtl='.$prod_result[1].'">'.$prod_result[1].'</a></li>';
								}
							?>
						</ul>
						<!--
