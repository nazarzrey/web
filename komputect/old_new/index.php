<?php
	...
	define("Web","http://komputeclift.com/");
?>
...
?>
<title>Lift Barang  - Komputeclift - <?php
$sql1 = mysql_query("select distinct product from project order by product");
if ($sql1){
...
<meta name="description" content="<?php
	$sql = mysql_query("select isi_content  from  content where id_content='GOOGLE'");
	if ($sql){
...
<div id="container">
    ...
    <div id="top-content">
		...
		<div id="slide_image"><?php require_once("slide_show.php");?>
		</div>
		<?php 
		}else{
			?>
    ...
    <div id="bot-content">
		...
		<div class="content-right">
			<div class="arrowlistmenu">		
					<div class="menuheader" style="overflow:auto;">
					...
					<div class="menucenter expandable">Produk</div>
						<ul class="categoryitems">
                        	<?php 
								$prod_query = mysql_query("SELECT DISTINCT product_id,product_name FROM product WHERE IFNULL(recid,'0')<>'X' ORDER BY urut ") or die (mysql_eror());
    ...
    <div id="footer-in">			
		...
		<div style='float:right;font-size:10px;'>Dev by <a href='http://www.softwarenya.com' style='color:white;text-decoration:none;'>Softwarenya.com</a></div>
    </div>
</div>
</body>
</html>