	...
	if ($sql)
		{
			...
			{
				echo "<div style='float:left;padding-right:10px;'><i style='font-size:10px;'>".$data['id']."</i><br/>";
				echo '<a href="ymsgr:sendIM?'.$data['id_mail'].'"> <img src="http://opi.yahoo.com/online?u='.$data['id_mail'].'&amp;m=g&amp;t=2&amp;l=us" style="max-width:115px;"/></a></div>';
			}
		}else{
