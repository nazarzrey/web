...
if(isset($_GET['project_id'])){
	//echo $Adelia;
	$Adelia = "SELECT * from project where project_id='".$_GET['project_id']."'";
    $Prld_query = mysql_query($Adelia) or die (mysql_error());
...
?>
    <span style="float:left;margin-bottom:10px; font-size:20px;">
    <?php
	...
	$nomor = mysql_num_rows($Gs_query);
    if(isset($_GET['proyek_dtl'])){
		$url_proyek = str_replace("-"," ",$_GET['proyek_dtl']);
        echo "<i>".$nomor." Project ".$url_proyek."</i>";
    }else{
		echo "<i>Proyek Kami</i>";
	}
    ?>
    </span>
