                ...
                <div class="login-wrap" >
                    <div class="login-content" style="box-shadow: 0 0 15px #ccc">
                        <div class="login-logo">                            
                            <div style="border-bottom: solid 1px #fff;padding: 15px 0;margin-bottom: 15px;">
							<h4 style="line-height: 32px;font-size:28px;">Masjid <br/>Jami' Al-hidayah</h4></div>
                            <span>Silahkan masukan <b>PIN</b> <br/>untuk nama KK <b class="text-warning"><?php echo strtoupper(str_replace("-"," ",$warga[0])) ?></b><br/>yang tertera di kartu INFAQ</span>
                        </div>
