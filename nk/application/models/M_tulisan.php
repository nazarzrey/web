...
class M_tulisan extends CI_Model{
	...
	function utama(){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_tulisan where tulisan_kategori_id='1' ORDER BY tulisan_id DESC");
		return $hsl;
	}
