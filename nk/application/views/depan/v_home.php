            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <div class="col-md-4">
                        <img src="<?php echo base_url().'theme/images/logo yayasan.png'?>" width="50px">   
                        <!-- <h2><a href="<?php echo site_url('');?>" rel="home"> <b style="font-size: large;">SDI NURUL KARIMAH</b> </a></h2> -->
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/pertama.jpg'?>" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/kedua.jpg'?>" alt="Second slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/ketiga.jpg'?>" alt="Third slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            ...
                            <div class="slider-btn">
                                <p><a href="<?php echo site_url('galeri');?>" class="btn btn-default">Learn more</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <?php
                if($utama->result_array()){
                    echo $utama->result_array()[0]["tulisan_isi"];
                }else{
                    echo "<div class='mt-5 pt-5'></div>";
                } ?>
                Kepala Sekolah 
                <br/>
                <?= $kepsek->result_array()[0]["guru_nama"] ?>
            </div>
            <div class="col-md-4">
                <img src="<?php echo base_url().'assets/images/'.$kepsek->result_array()[0]["guru_photo"] ?>" class="img-fluid about-img" alt="#" style="border-radius:20px">
            </div>
        </div>
    </div>
</section>
