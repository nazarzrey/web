    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="col-md-5">
                    <img src="<?php echo base_url().'theme/images/ust tarmidzi.jpg'?>" class="img-fluid" alt="#">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <h4 class="quote_text">
                                لَا وَطَنَ لِلْجَاهِلِ وَلَا غَرَابَةَ لِلْعَالِمِ
                                <br>  Tidak ada tempat tinggal bagi orang bodoh dan tidak ada tempat asing bagi orang terpelajar.</h4>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/logo yayasan.png'?>" class="img-fluid" alt="#">
                                <p><span>Motto</span>SDI Nurul Karimah</p>
                            </div>
                        </div>
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <h4 class="quote_text">"Membangun Generasi Qur'ani Yang Taat Kepada Allah dan Nabi"</h4>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/logo yayasan.png'?>" class="img-fluid" alt="#">
                                <p><span>Slogan</span>SDI Nurul Karimah</p>
                            </div>
                        </div>
                    </div>
                </div>
