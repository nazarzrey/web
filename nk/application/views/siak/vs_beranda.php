          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data SDI Nurul Karimah</h1>
          ...
          <div class="row">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="mb-0 text-gray-800 fs-1">
                        <?php
                        if(isset($guru)){
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="mb-0 text-gray-800">
                        <table border="1" class="w-100 td-center">
                        <thead><th>Kelas</th><th>L</th><th>P</th><th>Total</th></thead>
                        <tbody>
                        <?php 
                        if(isset($siswa)){
                          foreach ($siswa as $key => $s) {
                            $siswa_jenkel = explode(",",$s->siswa_jenkel);
                            echo "<tr><td>".
                                str_replace("Kelas ","",$s->kelas_nama)."</td><td>".
                                $siswa_jenkel[0]."</td><td>".
                                $siswa_jenkel[1]."</td><td>".
                                $s->total."</td></tr>";
                          }
                        }; ?>
                        </table>
            ...
            <!-- Earnings (Monthly) Card Example -->
            <div class="col-xl-3 col-md-6 mb-4 hide">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Bayaran Siswa</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
