        ...
        setTimeout(() => {
          ...
          for($x=0;$x<=($ttl-1);$x++){
            if($data[$x]["tab_tanggal"]=="total"){
              $("#dataTableMore tbody").append("<tr class='bg-primary text-light'><td>"+$data[$x]["tab_tanggal"]+"</td><td>"+$data[$x]["tab_in"]+"</td><td>"+$data[$x]["tab_out"]+"</td><td>"+$data[$x]["saldo"]+"</td></tr>")
            }else{
              if($x==0){
              ...
              $("#dataTableMore tbody").append("<tr><td>"+$data[$x]["tab_tanggal"]+"</td><td>"+$data[$x]["tab_in"]+"</td><td>"+$data[$x]["tab_out"]+"</td>"+$tdlast+"</tr>")
            }
          }          
        }, $time);
      }
