...
<head>
  ...
  <title>SIAK Siswa <?php if(isset($title)){ echo "| ".$title;} ?></title>
...
<body class="bg-gradient-warning" id="uid" uid="<?= $this->session->userdata("idadmin") ?>" base-url="<?= "/".$this->uri->segment(1)."/".$this->uri->segment(2)."/" ?>">
