...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"> <img width="170px;" src="<?php echo base_url().'assets/images/logosklh.png'?>"></p><hr/>
    ...
    <form action="<?php echo site_url().'admin/login/auth'?>" method="post">
      ...
      <div class="row">
        <div class="col-xs-8  pl-2" style="padding-left:40px">
    ...
    <!-- /.social-auth-links -->
    <hr/>
    <p><center>Copyright 2020 by TeamPKM.Unpam<br/> All Right Reserved</center></p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
