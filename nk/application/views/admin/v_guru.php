                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnip" class="form-control" id="inputUserName" placeholder="NIP" required value="<?= $newnip ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Struktur Sekolah</label>
                                        <div class="col-sm-7">
                                            <select  name="xmapel" class="form-control" id="inputUserName" required>
                                              <option value="">Pilih Matapelajaran</option>
                                              <?php 
                                              foreach ($stru->result_array() as $key => $z) {
                                                echo "<option value='".$z["struktur_id"]."'>".$z["struktur_nama"]."</option>";
                                              } ?>
                                            </select>
                                          <i class="mt-1 text-info">Data di tambahkan di menu struktur</i>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          <?php 
                                              // dbg($stru2->result_array() );
                                               ?>
                                            <select  name="xmapel" class="form-control" id="inputUserName" required>
                                              <option value="">Pilih Matapelajaran</option>
                                              <?php 
                                              foreach ($stru2->result_array() as $key => $z) {
                                                if($struktur_id==$z["struktur_id"]){
                                                  echo "<option value='".$z["struktur_id"]."' selected>".$z["struktur_nama"]."</option>";
                                                }else{
                                                  if($z["struktur_unik"]!=1){
                                                    echo "<option value='".$z["struktur_id"]."' >".$z["struktur_nama"]."</option>";
                                                  }
                                                }
                                              } ?>
