        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
			 ...
			 <span class='text-warning'><i>Penambahan Siswa Baru di menu Peserta Didik Baru</i></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        ...
                        <?php }else{ ?>
                        <a class="btn no-delete" data-toggle="modal" ><span class="fa fa-trash  text-danger"></span></a>
                        <?php } ?>
                  </td>
                </tr>
				<?php endforeach;?>
...
<script>
  $(function () {
    ...
    $(document).on("click",".no-delete",function () {
      alert("data tidak bisa di hapuskan karena ada tabungannya");        
    })
</script>
