...
class Siswa_nabung extends Settings {
	...
	function index(){
		$data[] = "";
		$this->siswa_template("blank",$data);
	}
	function alldata($value=""){
		...
		$this->siswa_template("vs_tabungan",$data);
	}
	...
	function input($periode=""){
		...
		$this->siswa_template("vs_input_tabungan",$data);		
	}
	...
	// 	$data["alltabungan"] = $tabungan;
	// 	$data["opt_tanggal"] = $optionTgl;
	// 	$this->siswa_template("vs_report_tabungan",$data);		
	// }
	function periode(){
		$data[] = "";
