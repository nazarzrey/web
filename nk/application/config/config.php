...
|
*/
// $config['base_url'] = 'https://nurulkarimah.sch.id';
...
if ($sv == "localhost" || $sv == "127.0.0.1" || substr_count($sv, "192") == 1) {	
	...
	}elseif($_SERVER['HTTP_HOST'] == 'siswa.nurulkarimah.sch.id'){
		$config['base_url']  = "https://siswa.nurulkarimah.sch.id" . $newurl;
	}else{
