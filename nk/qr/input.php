 ...
 */
 ...
 <form method="post" action="">
	<input type="text" name="inputan" id="inputan" style="width:500px;padding:5px" autocomplete="off"/><p/>
 ...
 if(strlen($post)==0){
   ...
   # echo get_current_url($_SERVER);
	#$data = get_current_url($_SERVER)."/".$post; #http://192.168.72.145:8515/lampiran/G03420161022021224f54c7f87b1.jpg";
	$data = $post; #http://192.168.72.145:8515/lampiran/G03420161022021224f54c7f87b1.jpg";
    $lampiran = strtolower($post);
