...
<link href="gaya/jquery.mCustomScrollbar.css" rel="stylesheet" />
...
<div id="container">
	...
	<div id="header">
		...
		<div id="profile_menu">
			<ul>
			  ...
			  <li><a class="active"  href="?page=admin_page">Login</a></li>
			</ul>
		</div>
		...
		<div id="menu_mobile_hdr">
			...
			<ul>	 
				...
				<div class="menu_mobile">
					...
					<li><a href="?page=admin_page">Login</a></li>				    
				</div>
			</ul>
		</div>
	</div>
	...
	<div id="footer">
		...
		<div id="footer"  style="background:#29343e;width:100%;float:left;">
			<div class="footer copyright">copyright dinas binamarga @ 2016</div>
		</div>
	</div>
</div>
</body>
