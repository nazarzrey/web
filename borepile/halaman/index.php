...
<head>
	...
	<meta name="keywords" content="<?php
					...
					foreach ($cek_tags as $hsl_cek_tags) {
						echo ucwords($hsl_cek_tags["desc2"]) . ", ";
					}
					?>" />
	...
	<base href="http://localhost:212/kbp/">

	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css?v3" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
	<link href="gaya/dialog.css?v3" rel="stylesheet" type="text/css" media="screen" />
	...
	<link href="gaya/modal.css?v3" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="skrip/autosize.min.js?v3"></script>
