	...
	<form method="post" action="" enctype="multipart/form-data">
		<table>
			...
			<tr>
				...
				<td>
					<input type='text' class='input wx500' required name='post_4' id='post_4' maxlength="100" autocomplete="off" placeholder="*" value="<?= ready_data($field4); ?>" />
				</td>
			</tr>
			<tr>
				<td width="10%" class="td_right">Wa</td>
				<td>
					<input type='number' class='input wx500' required name='post_wa' id='post_wa' maxlength="100" autocomplete="off" placeholder="*" value="<?= ready_data($field_wa); ?>" />
				</td>
			</tr>
			<tr>
				<td width="10%" class="td_right">Alamat detail</td>
				<td>
