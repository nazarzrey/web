<div id="dialog2">
	<div class="dialog2" style="">
		...
		<?php echo $notif;?>
		<a href="<?php echo $Url_direct2."&info_action=hapus";?>" class="dialog2_closed" style="margin-right:25px;">Hapus</a><a href="<?php echo $Url_direct;?>" class="dialog2_closed">X</a>
		</div>
		<div class="dialog2_bot" >
			<textarea readonly><?php echo $msg;?></textarea>
		</div>							
	</div>
</div>
...
<div id="dialog2">
	<div class="dialog2" style="width:500px;height:auto;overflow:hidden;margin-top:150px;">
		...
		<a href="<?php echo $Url_direct2;?>" class="dialog2_closed">X</a>
		</div>
		<div class="dialog2_bot"  style="height:120px;overflow:hidden">
			<textarea readonly style="text-align:center;height:50px;overflow:hidden;"><?php echo $notif;?></textarea>
